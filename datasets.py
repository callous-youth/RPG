...
__all__ = ['mnist_dataloader', 'cifar10_dataloader','cifar10_dataloader_mix_up', 'cifar100_dataloader', 'tiny_imagenet_dataloader',
...
def cifar10_dataloader_mix_up(batch_size=64, data_dir='./data/', val_ratio=0.1):
    base_folder = "cifar-10-batches-py/"
    data_dir=data_dir+base_folder
    train_transform = transforms.Compose([
    ...
    train_set = Subset(CIFAR_Dataset(data_dir, train=True, transform=train_transform), list(range(train_size)))
    val_set = Subset(CIFAR_Dataset(data_dir, train=True, transform=test_transform),
                     list(range(train_size, train_size + val_size)))
    test_set = CIFAR_Dataset(data_dir, train=False, transform=test_transform)
